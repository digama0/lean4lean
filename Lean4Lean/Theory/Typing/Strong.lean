...
theorem IsDefEq.strong' (hΓ : CtxStrong env U Γ)
  ...
  | @const _ _ ls' _ h1 h2 h3 =>
    let ⟨u, h4⟩ := envIH.1 h1
    exact .const h1 h2 h3 (.inst h2) (h4.1.instL h2)
